...
/**
 * Implementation of Reflection WellNus' <code>help</code> command. Explains to the user what commands are supported
...
public class HelpCommand extends Command {
    ...
    private ArrayList<String> getCommandDescriptions() {
        ...
        commandDescriptions.add(FavoriteCommand.COMMAND_DESCRIPTION);
        commandDescriptions.add(GetCommand.COMMAND_DESCRIPTION);
    ...
    public void printGeneralHelpMessage() {
        ...
        String outputMessage = ReflectionManager.FEATURE_HELP_DESCRIPTION;
